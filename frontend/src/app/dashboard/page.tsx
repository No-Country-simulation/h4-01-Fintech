...
export default function Page() {
  ...
  const riskPercentage = useQuestions().riskPercentage ?? null; // ✅ Corrección aquí

  // ⏳ Calculamos el perfil y mensaje solo cuando cambie `riskPercentage`
          ...
          <Card className="mb-8 p-6 bg-slate-200 rounded-lg shadow-sm">
            ...
            <Flex direction={{ initial: 'column', md: 'row' }} align="center" gap="5">
              <Image
                ...
                width={192}
                height={192}
                className="w-32 h-32 md:w-48 md:h-48 rounded-lg border-2 border-gray-600 object-cover"
              />
